...
from algorithms.bots.base_enums import BotMoneyMode, ReturnType, BotStatus, \
    BotAction, InvestmentIntervalScale, RunningMode
...
class Bot(Base):
    ...
    running_mode = Column(Enum(RunningMode), nullable=True)
